...
│   │   ├── decision_tree_classifier_submission.csv
│   │   ├── k-nearest_neighbour_submission.csv
...
│   │
│   ├── Decision_Tree_Classifier.ipynb # Training notebooks
│   ├── Ensemble_Random_Forest.ipynb
│   ├── Ensemble_XGBoost.ipynb
│   ├── K-Nearest_Neighbor_Classifier.ipynb
│   ├── Logistic_Regression.ipynb
│   ├── Models_Comparision.ipynb
│   ├── Naive_Bayes_Classifier_Gaussian.ipynb
│   └── Streamlitapp.ipynb
│
├── README.md                       # This file	
